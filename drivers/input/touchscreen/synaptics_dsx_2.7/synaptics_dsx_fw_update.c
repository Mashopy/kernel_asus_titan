...
//	char firmware_ver[HARDWARE_MAX_ITEM_LONGTH];
	...
	snprintf(synap_firmware_ver,64,"TCL,synaptics,FW:%02x%02x%02x%02x",*(fwu->config_id),*(fwu->config_id+1),*(fwu->config_id+2),*(fwu->config_id+3));
