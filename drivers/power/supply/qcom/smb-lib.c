...
#define ARA_750K_MIN				675
#define ARA_750K_MAX				851
#define ARA_200K_MIN				306
#define ARA_200K_MAX				406
...
void asus_chg_flow_work(struct work_struct *work)
{
	...
	case DCP_CHARGER_BIT:
		...
		if (HVDCP_FLAG == 0) {
			...
			schedule_delayed_work(&smbchg_dev->asus_adapter_adc_work, msecs_to_jiffies(5*ADC_WAIT_TIME_HVDCP0));
...
//ASUS Adapter Detecting +++
 ...
 void CHG_TYPE_judge(struct smb_charger *chg)
{
	int adc_result;
	int ret;
	int MIN_750K, MAX_750K, MIN_200K, MAX_200K;

	MIN_750K = ARA_750K_MIN;
	MAX_750K = ARA_750K_MAX;
	MIN_200K = ARA_200K_MIN;
	MAX_200K = ARA_200K_MAX;
...
extern u8 us5587_adapter_value(void);
 ...
 void us5587_CHG_TYPE_judge(struct smb_charger *chg)
{
	u8 adc_result;
	int ret;
	u8 MIN_750K, MAX_750K, MIN_200K, MAX_200K;

	MIN_750K = (u8)TITAN_750K_MIN;
	MAX_750K = (u8)TITAN_750K_MAX;
	MIN_200K = (u8)TITAN_200K_MIN;
	MAX_200K = (u8)TITAN_200K_MAX;
