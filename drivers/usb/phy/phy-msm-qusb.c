...
static int qusb_phy_init(struct usb_phy *phy)
{
	...
	//  ZE620KL_SR : 0
	//  ZE620KL_ER : 2
	pr_info("[USB] %s(): Current hardware ID : (%d), current project ID : (%d)", __func__, g_ASUS_hwID, g_ASUS_prjID);
	switch(g_ASUS_hwID){
		case ZE620KL_ER:
	...
	} else if(g_ASUS_prjID==0x5 || g_ASUS_prjID==0x7){
		default_device_parameter_1=0xf8;
		default_device_parameter_2=0x3f;
		default_device_parameter_3=0x83;
		default_device_parameter_4=0xc7;
		default_host_parameter_1=0xf8;
		default_host_parameter_2=0x2f;
		default_host_parameter_3=0x83;
		default_host_parameter_4=0xc7;
	}
